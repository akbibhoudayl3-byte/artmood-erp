          ...
          {cost && (() => {
            ...
            return (
              <>
                ...
                <p className="text-center text-xs text-[#64648B] italic">Places limitées en production cette semaine</p>
                <p className="text-center text-xs text-[#64648B]">Vous confirmez votre cuisine telle que configurée</p>
