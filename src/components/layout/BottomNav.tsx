...
import { LayoutDashboard, Users, FolderKanban, Factory, Wallet, MoreHorizontal, Package, Calendar, CalendarOff, Wrench, UserCheck, Megaphone, Settings, FileText, ClipboardList, ScanLine, Truck, ShoppingCart, AlertTriangle, PieChart, Monitor, Star, ChefHat, Receipt } from 'lucide-react';
